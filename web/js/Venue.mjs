...
export class Venue extends React.Component {
	render() {
		return create("div", { className: "venue" },
			create("p", {}, "We're getting married in Stern Grove, a beautiful park in San Francisco. We've rented out the clubhouse in this sweet park by the ocean. Don't forget to bring your sweater!"),
